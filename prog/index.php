...
<head>
    ...
    <script>
        function updateTime() {
            var startDate = new Date('2025-04-30T23:59:00Z'); // Start date and time set to 3 PM UTC
...
<body onload="updateTime()">
    <div>
        <h1>Progesterone started on April 30th, 2025 ⚕️💊👩:</h1>
        <p id="timeElapsed"></p>
        ...
        <p><a href="https://hrt.lp0.uk/"><img src="https://img.shields.io/badge/HRT-Estrogel%20Tracker-blue"/></a></p>
